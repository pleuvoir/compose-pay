    ...
    <script>
   	var j;
        ...
        function dataButton(cellvalue, options, rowdata){
        	...
        	var showUrl = '<c:url value="/payType/show"/>';
        	editUrl = joinUrlParam(editUrl, {code: cellvalue});
        	
        	var rtnStr = "<shiro:hasPermission name="payType:list"><a class='btn-xs btn-success' href='"+showUrl+"' title='查看'><i class='fa fa-book'></i></a>&nbsp;</shiro:hasPermission>";
