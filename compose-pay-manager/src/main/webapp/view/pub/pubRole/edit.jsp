    		...
    		<div class="col-lg-12">
    			<div class="ibox">
                    ...
                    <div class="ibox-content">
						...
						<form id="edit-form" class="form-horizontal" action="<c:url value="/pubRole/update"/>" method="post">
	                        <div class="row">
	                            <div class="col-md-3">
	                                <div class="form-group">
	                                	<label class="col-lg-4 control-label">名称</label>
                                    	<div class="col-lg-8">
                                    		<input type="text" placeholder="名称" class="form-control" name="name" value="${role.name}">
                                    		<input type="text" class="hide" name="id" value="${role.id}">
                                    	</div>
                                	</div>
	                            </div>
	                        </div>
	                        <div class="row">
	                            <div class="col-md-6">
	                                <div class="form-group">
                                    	...
                                    	<div class="col-lg-10">
                                    		<input type="text" placeholder="备注" class="form-control" name="remark" value="${role.remark}">
                                    	</div>
                                	</div>
	                            </div>
	                        </div>
